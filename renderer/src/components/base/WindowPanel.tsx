...
import {ApplicationService, Model} from "../../../bindings/github.com/LoliE1ON/wails3-react-ts/domain/application/service";
            ...
            <div className="flex justify-between items-center bg-transparent app__drag-area cursor-default w-full">
                <div className="font-semibold text-sm ml-4">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <div className="text-xl font-semibold">Application</div>
                    </div>
                </div>
                <div className="py-4 px-4 text-sm flex flex-row gap-4">text</div>
